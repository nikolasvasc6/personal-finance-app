...
export const Input: React.FC<InputProps> = ({
  ...
  return (
    <View className={`w-full mb-5 ${className}`}>
      ...
      <View 
        className={`flex-row items-center w-full bg-surface-dark border rounded-2xl px-4 py-4 min-h-[58] ${
          error ? 'border-danger' : 'border-border-dark focus:border-primary'
        }`}
      >
